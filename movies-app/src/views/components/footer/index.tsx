...
function Footer() {
    return (
        <div className='footer_main relative'>
            <div className='footer_top flex justify-center items-start gap-20 p-6 h-36 sm:gap-6 sm:p-2 sm:h-12'>
                {/* <div className='absolute left-20 top-5'>
                <PopcornLogo height={80} width={80} color="#ffffff"/>
                </div> */}
                <div className='footer_about_us block sm:hidden'>
                    <h1>COMPANY</h1>
